...
function ChatInfo(){
   ...
   //       // const authUserFound =  query(usersMessages, where("usersId", "in", [[valueData.authUser.uid, valueData.currentUser.uid], 
   //       // [valueData.currentUser.uid, valueData.authUser.uid]]));
