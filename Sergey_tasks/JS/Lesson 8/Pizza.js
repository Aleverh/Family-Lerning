...
quantity.addEventListener("click", () => {
   ...
   closeModalPizza(); 
   //--------------------------------------------------------------------
      // if( localStorage.getItem("pizzaName") === tableName.textContent){ 
      //    tableCount.textContent = parseInt(tableCount.textContent) + parseInt(localStorage.getItem("quantity"));
      //    tableSum.textContent = pizzaPriceOrder * parseInt(tableCount.textContent);
      // }
      // else {
      //    const trClon = tr.cloneNode(true);
      //    table.append(trClon);

      //    tableName.textContent = localStorage.getItem("pizzaName");
      //    tableCount.textContent = localStorage.getItem("quantity");
      //    tablePrice.textContent = localStorage.getItem("price");
      //    tableSum.textContent = localStorage.getItem("price") * localStorage.getItem("quantity");
      // }
   //-------------------------------------------------------------------
